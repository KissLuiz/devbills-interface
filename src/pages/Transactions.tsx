...
const Transactions = () => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: <AAAAJA>
  useEffect(() => {
    fetchTransactions();
  }, [year, month]);
  ...
  return (
    <div className="container-app py-6">
      <div className="flex fle-col md:flex-row justify-between items-start md:items-center mb-6">
        <h1 className="text-2xl font-bold mb-4 md:mb-0">Transações</h1>
        <Link
          to="/transacoes/nova"
          className="bg-primary-500 text-[#051626] font-semibold px-4 py-2.5 rounded-xl flex items-center justify-center hover:bg-primary-600 transition-all duration-300"
        >
          <PlusIcon size={24} className="w-4 h-4 mr-2" />
          Nova Transação
        </Link>
      </div>
      ...
      <Card className="overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link
              to="/transacoes/nova"
              className="w-fit mx-auto mt-6 bg-primary-500 text-[#051626] font-semibold px-4 py-2.5 rounded-xl flex items-center justify-center hover:bg-primary-600 transition-all duration-300"
            >
              <PlusIcon size={24} className="w-4 h-4 mr-2" />
              Nova Transação
            </Link>
            ...
            <table className="divide-y divide-gray-700 min-h-full w-full">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="px-3 py-3 text-left text-xm font-medium text-gray-400 uppercase"
                  >
                    Descrição
                  </th>
                  <th
